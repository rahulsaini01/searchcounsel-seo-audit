		...
		wp_localize_script(
			...
			array(
				...
				'i18n'              => array(
					...
					'pageSpeedAnalyzingScore' => __( '%s PageSpeed performance is being analyzed', 'searchcounsel-seo-audit' ),
					'analyzingPerformance' => __( 'Analyzing performance…', 'searchcounsel-seo-audit' ),
					'analyzingShort'  => __( 'Analyzing…', 'searchcounsel-seo-audit' ),
